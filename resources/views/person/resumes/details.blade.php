                            ...
                            <div class="row">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <div class="mb-3 col-md-5">
                                        <a href="{{ '/usuario/curriculo/'.base64_encode($res->id).'/editar' }}"><button class="btn btn-primary fw-bold fs-4"> Editar </button></a>
                                        <a href="{{ '/usuario/curriculo/'.base64_encode($res->id).'/excluir' }}"><button class="btn btn-danger fw-bold fs-4"> Excluir </button></a>
                                    </div>
                                </div>
