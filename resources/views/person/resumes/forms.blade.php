...
@section('title', 'Cadasotro de Currículo')
      ...
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            @endif
            <form action="{{ url('/usuario/curriculo/cadastro') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
      ...
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            @endif
            <form action="{{ url('/usuario/curriculo/'.$formEdit->id.'/editar') }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Telefone:</label>
