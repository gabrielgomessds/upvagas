      ...
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            @endif
            <label class="form-label fs-5 text-primary fw-bold" for="basic-default-fullname">{{request('company_id') ? 'Empresa:'.$company->name : ''}} </label>
            <form action="{{ url('/corporativo/vagas/cadastro') }}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
                @if(isset($company->id))
                ...
                @else
                <div class="mb-3">
                  <label class="form-label" for="basic-default-company">Empresa: </label>
                  <select class="form-control" name="company_id" id="basic-default-company">
                    <option disabled selected>Escolha uma empresa</option>
                    @foreach($userCompanys as $corp)
              ...
              <div class="mb-3">
                ...
                <input type="text" name="localization" class="form-control" id="basic-default-company" placeholder="Localização onde a será a vaga" value="{{$company ? $company->localization : ''}}" />
              </div>
              ...
              <div class="mb-3">
                ...
                <select class="form-control" name="hiring_type" id="basic-default-company">
                  <option disabled selected>E scolha uma opção</option>
      ...
      <div class="col-xl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            ...
            @endif
            <form action="{{ url('/corporativo/vaga/'.$formEdit->id.'/editar') }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <div class="mb-3">
