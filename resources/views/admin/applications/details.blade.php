            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="mx-3 mt-3">
                            <h5 class="alert alert-success mb-2 text-center">Esse candidato foi <b>{{ $application->situation == 'accepted' ? 'aceito' : 'recusado'  }}</b> nessa vaga</h5>
                        </div>
                        @endif
                        <!-- Account -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="mb-3 col-md-5">
                                    <a href="{{ '/admin/vaga/aplicacoes/curriculo/'.base64_encode($application->id).'/aceitar' }}"><button class="btn btn-primary fw-bold fs-4"> Aceitar </button></a>
                                    <a href="{{ '/admin/vaga/aplicacoes/curriculo/'.base64_encode($application->id).'/recusar' }}"><button class="btn btn-danger fw-bold fs-4"> Recusar </button></a>
                                </div>
                            </div>
